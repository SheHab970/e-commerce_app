      ...
      <div className="flex flex-col gap-8 items-center justify-center mt-12">
        ...
        <div className="flex items-center gap-8 lg:gap-16">
          {steps.map((step) => (
            ...
            >
              <div
                className={`w-4 h-4 lg:w-6 lg:h-6 text-sm font-medium rounded-full flex items-center justify-center text-white p-3 lg:p-4 ${step.id === activeStep ? "bg-gray-800" : "bg-gray-400"}`}
              >
                {step.id}
              </div>
              <p
                className={`text-xs lg:text-sm font-medium ${step.id === activeStep ? "text-gray-800" : "text-gray-400"}`}
              >
                {step.title}
              </p>
            </div>
